...
SECRET_KEY = 'django-insecure-q&6w8bud+fuufczi^paj6b*-ta@lkzbg8qj&s!hjs!$__%h#!-'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'img',
        'USER': 'root',
        'PASSWORD': 'nitinrinki7777',  # Ensure this is correct
        'HOST': 'localhost',  # Or the actual MySQL server's address
